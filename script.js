...
const LINK_PATTERN = /(?:https?:\/\/|www\.)[^\s<>"'`]+|(?:[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?\.)+(?:com\.vn|net\.vn|org\.vn|edu\.vn|gov\.vn|vn|com|net|org|info|biz|io|co|me|app|dev|link|ly|gl|cc|top|xyz|shop|site|online|icu|click|live|asia|store|vip|cloud|at|so|id|in)(?:\/[^\s<>"'`]*)?/gi;
const KNOWN_PUBLIC_SUFFIXES = ["com.vn", "net.vn", "org.vn", "edu.vn", "gov.vn"];
